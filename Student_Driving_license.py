...
label_heading = canvas.create_text(200,20, font=('Times', '50', 'bold italic') ,text="Driving License", fill = "red")
...
def print():
    ...
    label_id_tag["text"]= "ID: 9238298292"
    label_name_tag["text"]= "Name: -_-"
    label_dob_tag["text"]= "Date of Birth: 21 August 1987"
    label_pin_tag["text"]= "Pin: 3234"
    label_address_tag["text"]= "Adress: 932 Khalupa Way"
    label_vehicle_type_tag["text"]= "Veichle Make: Toyota"
btn = Button(root, text="Show", command=print)
btn.pack()
label_heading.pack()
label_id_tag.pack()
label_name_tag.pack()
